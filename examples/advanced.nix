...
in {
  ...
  in {
    base = baseLogger.info "Base logger" {
      message = "This is a base logger message";
    };
    module = moduleLogger.info "Module logger" {
      message = "This is a module logger message";
    };
    submodule = submoduleLogger.info "Submodule logger" {
      message = "This is a submodule logger message";
    };
  };
}
